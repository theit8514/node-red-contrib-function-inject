...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("functioninject",FunctionInjectNode);
    //RED.library.register("functions");

    RED.httpAdmin.post("/functioninject/:id", RED.auth.needsPermission("inject.write"), function(req,res) {
